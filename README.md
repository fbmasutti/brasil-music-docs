...
Antes de cadastrar seu primeiro show, prepare a base da sua conta para automatizar a geração de documentos, contratos e peças de divulgação.

### 1. Cadastro Geral e Dados Fiscais
...
### 2. Configuração do Brand Kit (Identidade Visual)
...
## 🔄 Workflow do Show: Passo a Passo
...
### Step 3: Formalização do Contrato

1. Acesse [Contratos & Recibos](https://www.google.com/search?q=https://stage-kit.lovable.app/documentos) ou utilize o atalho no Dashboard.
2. Selecione o contratante e o show cadastrado.
3. Gere o documento em PDF ou envie o link de assinatura diretamente via WhatsApp.

---

### Step 4: Divulgação em Redes Sociais

1. Acesse o [Gerador de Posts](https://www.google.com/search?q=https://stage-kit.lovable.app/gerador-cards).
2. Selecione o evento e o **Brand Kit** correspondente à proposta artística.
3. Escolha o formato desejado (**Stories 9:16** ou **Feed 1:1**).
4. Clique em **Exportar Imagem (PNG)** para baixar a peça pronta.

---

### Step 5: Fechamento, Portfólio e Clipping

1. **Controle Financeiro:** Acompanhe o pagamento de cachês e pendências em [Financeiro & Cachês](https://www.google.com/search?q=https://stage-kit.lovable.app/financeiro).
2. **Documentos de Pós-Show:** Emita recibos, RPAs e o relatório de setlist para envio ao [ECAD](https://www.google.com/search?q=https://stage-kit.lovable.app/repertorio).
3. **Registro Histórico:** Após a realização do show, cadastre fotos, matérias de imprensa e registros na aba [Portfólio & Clipping](https://www.google.com/search?q=https://stage-kit.lovable.app/portfolio) para manter o histórico atualizado para futuros editais e apresentações comerciais.
